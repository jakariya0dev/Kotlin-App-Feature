...
class QuizQuestion(ques :String, opt1 :String, opt2 :String, opt3 :String, opt4 :String, ans :String, selectedAns :String = "") {
    ...
    lateinit var mSelectAns :String
